...
tags = ['rgb_original_mc', 'flow_original_mc', "conv1_1minus_rgb5"]
...
score_weights = [[1, 2, 0], [1, 2, 1], [1, 2, 2], [1, 4, 1], [1, 6,2], [1, 4,2], [1,5,2]]
combine_score(tags, fpkls, score_weights)
exit()

tags = ['flow_original_mc', "conv1_1minus_rgb5"]
fpkls = ["../pkl/full_test_flow_fc8_mirror_crop_seg25.pkl", \
        "../pkl/full_test_conv1_1minus_rgb5_initfromvgg_iter30000_mirror_crop_seg25.pkl"]
...
tags = ['rgb_original_mc', "conv1_1minus_rgb5"]
fpkls = ["../pkl/full_test_rgb_fc8_mirror_crop_seg25.pkl", \
	"../pkl/full_test_conv1_1minus_rgb5_initfromvgg_iter30000_mirror_crop_seg25.pkl"]
score_weights = [[1, 2], [1, 1], [2, 1], [1, 3], [3, 1]]
combine_score(tags, fpkls, score_weights)
