...
caffe.set_mode_cpu()
original_net = caffe.Net('./vgg_16_rgb_train_val_fast.prototxt', './cuhk_action_recognition_vgg_16_split1_rgb_comv1minus_iter_10000.caffemodel', caffe.TEST)
net = caffe.Net('./vgg_16_rgb5_conv1minus_train_val_fast.prototxt', caffe.TEST)
save_to_model = './vgg_16_conv1minus_rgb5_init.caffemodel'
